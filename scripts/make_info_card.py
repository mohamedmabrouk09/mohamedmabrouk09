...
# ===========================================================================
HOST = "mohamedmabrouk09"   # shown as  mohamedmabrouk09@github  in the header

ROWS = [
    ("host",),
    ("kv", "Edu", "Software Engineering student @ ENSA Khouribga"),
    ("kv", "Focus", "Backend, cloud, DevOps, and AI"),
    ("kv", "Project", "UM6P Stock Management System"),
    ("kv", "Stack", "Spring Boot, React, PostgreSQL, Docker, Liquibase"),
    ("gap",),
    ("sec", "Technologies"),
    ("kv", "Backend", "Java, Spring Boot, Python"),
    ("kv", "Frontend", "React, TypeScript, Tailwind CSS"),
    ("kv", "Cloud", "Docker, AWS, Kubernetes, CI/CD"),
    ("kv", "Data", "PostgreSQL, Redis, Kafka, RabbitMQ"),
    ("kv", "AI", "RAG, LangChain, LangGraph, vector databases"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built an IT asset management platform at UM6P"),
    ("bul", "Interested in clean architecture, systems, and AI"),
]
